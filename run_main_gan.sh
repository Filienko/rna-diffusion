...
python main_gan.py -dataset 'gtex' -gpu_device "cuda:0" -gpu_device2 "cuda:1"
...
python reverse_val_gan.py -dataset 'gtex' -with_best_params "y" -nb_runs 15 -gpu_vae "cuda:0" -gpu_mlp "cuda:1"
...
python reconstruction_mlp_from_gan.py -dataset 'gtex' -nb_runs 5 -nb_nn 50 -gpu_device "cuda:0" -device2 "cuda:1"
