...
def main():
    ...
    np.save(f'./src/generation/vae/logs/dict_res_metrics_5runs_{DATASET}.npy', dict_res_5runs)
    ...
    df.to_csv(f'./src/generation/vae/results/results_{DATASET}.csv', sep =',', header=True, index=False)
